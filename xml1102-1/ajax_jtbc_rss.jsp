		...
		if($("#newsType").selectedIndex != 0){
			...
			$.ajax({
				...
				success:function(xml){
					var output="<div>";
					//파싱
					output+="<strong>작성일</strong> : "+$(xml).find("pubDate").first().text()+"<br>";
					output+="<strong>설명</strong> : "+$(xml).find("description").first().text()+"<br>";
					...
					output+="<tr>";
					output+="<td>번호</td><td>"+(i+1)+"</td>";
					output+="<td>제목</td><td><a href='"+link+"'>"+title+"</a></td>";
