...
<style type="text/css">
#wrap{ width: 1012px;height: 678px; position: relative;margin: 0px auto;
background: #FFFFFF url('images/main_bg.png') no-repeat; }
#loginBox{ position: absolute; top: 256px; left: 770px;  }
...
String email1=dd.decryption(udVO.getEmail());
pageContext.setAttribute("name",name);
%>
<c:out value="${name}"/>님 어서오고<br>
